    ...
    <div>
      ...
      <div className=" pt-16 pb-12 bg-gray-200 ">
        <div className=" pt-6 max-w-[400px] md:max-w-[700px]  px-4 m-auto">
          <h2 className="text-center capitalize text-[1.2rem] font-semibold text-gray-700 pb-10">
            TS-WORLD PRIVACY NOTICE
          </h2>
          <div className="">
                ...
                <div>
                  <ul className=" pl-5 md:pl-7  pt-2 pb-6 text-[0.9rem] list-disc font-normal space-y-3">
                    <li>
                      ...
                      Qui, similique exercitationem. Voluptates quibusdam
                      consequatur numquam nam quis ratione accusamus tenetur.
                    </li>
                    <li>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Qui, similique exercitationem. Voluptates quibusdam
            ...
            <p className=" text-[0.9rem]">
              ...
              harum nihil ab ex aperiam sunt?
            </p>
          </div>
        </div>
      </div>
