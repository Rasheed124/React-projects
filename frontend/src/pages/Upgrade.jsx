          ...
          <form action="">
            ...
            {batteryType === 'companyBattery' && (
              <div className="company pt-6">
                ...
                <label htmlFor="desiredCapacity">
                  To which capacity of battery
                </label>
                <select
                  id="desiredCapacity"
            ...
            {(batteryType === 'otherLithiumBattery' ||
              batteryType === 'otherBattery') && (
              <div className="other pt-6">
                <label htmlFor="otherDetails">
                  State capacity of battery and desired upgrade capacity
                </label>
                <br />
                <div className="pt-2">
                  <textarea
            ...
            <br />
            <div className=" pb-12">
              <button className="mt-4 bg-gray-500 px-4 py-2 w-full rounded">
                Submit
              </button>
            </div>
          </form>
