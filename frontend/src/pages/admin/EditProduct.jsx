    ...
    axios
      ...
      .then(({ data }) => {
        ...
        setProductDetails({
          ...
          description: {
            description: product.description.description.join(", "),
            lightning: product.description.lightning.join(", "),
            keyFeatures: product.description.keyFeatures.join(", "),
            whatsInTheBox: product.description.whatsInTheBox.join(", "),
            specifications: product.description.specifications.join(", "),
          },
        });
            ...
            <form className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12" onSubmit={handleSubmit}>
              ...
              <div className="my-4">
                ...
                >
                  ...
                  <option value="lithiums">Lithium</option>
                  <option value="acids">Acid</option>
                  <option value="tubulars">Tubular</option>
                  <option value="solars">Solar</option>
                </select>
              </div>
              ...
              <div className="relative mt-4">
                <label htmlFor="image_upload">
                  <img
                    src={image ? (typeof image === 'string' ? image : URL.createObjectURL(image)) : upload_area}
                    alt="image upload"
                  />
                </label>
                <input
