...
const Repair = () => {
  ...
  return (
    <div>
      ...
      <div className="pt-16">
        <h2 className="text-center capitalize text-[1.2rem] font-semibold text-gray-700">
          Please fill in the form below
        </h2>
        <div className="pt-6 max-w-[400px] md:max-w-[600px] px-4 m-auto">
          <p className="text-[0.9rem] pb-6">
            <span className="text-[1rem] font-bold">Note:</span> Lorem ipsum
            dolor sit, amet consectetur adipisicing elit. Quo minima ex enim
            adipisci eum sit temporibus in placeat vel? Cumque!
          </p>
          <form onSubmit={handleSubmit}>
            ...
            <div className="">
              <label htmlFor="details" className="text-[1.1rem]">
                State The Issue
              </label>
              <br />
              <div className="pt-3">
            ...
            <div className="pt-6">
              <label htmlFor="attachment" className="text-[1.1rem] block mb-2">
                Attach a Picture or Video (Max 20MB)
              </label>
              <label
                htmlFor="attachment"
                className="bg-gray-500 hover:bg-gray-700 hover:text-white  text-gray-700 font-bold py-2 px-4 rounded outline-none cursor-pointer inline-block mb-4"
              >
                {fileButtonText}
              </label>
              <input
            ...
            <p className="py-6">
              ...
              Accusamus assumenda ad illo saepe officia facere totam animi
              tenetur consectetur! Fugit quis culpa dolorum hic quos at illum,
              aspernatur dicta vel.
            </p>
            ...
            <div className="pb-12">
              <button
                type="submit"
                className="mt-4 bg-gray-500  hover:bg-gray-700 hover:text-white px-4 py-2 w-full rounded"
              >
                Submit
              </button>
            </div>
