                  ...
                  <div className="max-w-6xl px-4 mx-auto text-left  grid grid-cols-1 md:grid-cols-2 gap-10 pb-24 ">
                    ...
                    <div className=" ">
                      <form action="">
                        ...
                        <div>
                          <textarea
                            className="w-full pt-4 pb-3 outline-none placeholder:text-lg  placeholder:text-deep-black bg-inherit border-b border-deep-black resize-y"
                            name=""
                            id=""
                            placeholder="Message"
                          ></textarea>
                        ...
                        <div className="flex justify-end mt-3">
                          <Link
                            className={`block hover:transition-colors duration-500 hover:text-header-dark-overlay`}
                            id="btn-link"
                            href=""
                          >
