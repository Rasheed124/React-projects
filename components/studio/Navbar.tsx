        ...
        <div>
            ...
            <div className=" p-6 text-light-white">
                ...
                <div className="flex space-y-3 md:space-y-0 flex-col md:flex-row justify-between  items-center">
                  ...
                  <Link href="/api/preview" className="font-bold text-lg font-Antonio border px-5 py-2">
                    Go Preview
                  </Link>
                  <Link href="/api/exit-preview"  className="font-bold text-lg font-Antonio  border px-5 py-2">
                    Exit Preview
                  </Link>
                  </div>
